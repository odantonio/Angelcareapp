...
class BloodPage extends StatefulWidget {
  BloodPage({Key? key}) : super(key: key);
...
// class DailyBloodChartDialog extends StatelessWidget {
//   final List<Map<String, dynamic>> data;
//
//   const DailyBloodChartDialog({Key? key, required this.data}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     return Dialog(
...
// }
//
// class DailyBlood extends StatelessWidget {
//   final List<Map<String, dynamic>> data;
//
//   const DailyBlood({Key? key, required this.data}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     return Chart(
...
//       marks: [
//         LineMark(
//           position: Varset('hour') * Varset('max') / Varset('name'),
//           shape: ShapeEncode(
...
//     await Future.delayed(const Duration(seconds: 94));
//
//     setState(() {
//       isLoading = false;
//     });
//   }
//
//   void showBloodChartDialog() {
//     showDialog(
//       context: context,
//       builder: (context) {
//         return DailyBloodChartDialog(data: bloodData);
//       },
//     );
//   }
//
...
//             const SizedBox(height: 16),
//             ElevatedButton(
//               onPressed: isLoading ? null : showBloodChartDialog,
//               child: const Text(' '),
//             ),
//           ],
//         ),
