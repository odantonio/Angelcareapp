...
class WeeklyHeartFrequency extends StatelessWidget {
  final List<Map<String, dynamic>> data;
  final DateTime date;
  const WeeklyHeartFrequency({
    Key? key,
    required this.data,
    required this.date,
  }) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final lastDayOfTheWeek =
        today.add(Duration(days: DateTime.daysPerWeek - today.weekday + 1));
    ...
    return Chart(
      ...
      marks: [
        IntervalMark(
          ...
          color: ColorEncode(
            value: const Color.fromRGBO(240, 98, 146, 1),
          ),
